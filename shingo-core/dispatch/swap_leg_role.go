...
//
//   - swap_hold.go's INDEX anti-collision arm asks placesLine && !takesLine
...
// the two_robot evac an outbound staging hop and it starts reading as
// self-sufficient, which silently disarms Face 1 for the mode it was written for.
// That pin lives in shingo-edge/engine, where the builders are.
