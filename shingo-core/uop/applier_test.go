...
// makeBucketLevel is one pile row's level as the Edge sends it, its flush
// window closing now.
func makeBucketLevel(coreNodeName, payloadCode string, state protocol.LinesideBucketState, qty, drained int, seq int64) *protocol.LinesideBucketLevel {
