...
| 2 | Swap starvation hold | a two-robot swap's evac leg pulling the line bin before its supply sibling has secured a replacement (strands the line) | `shingo-core/dispatch/complex_dispatch.go` — `swapRemovalLegHeld` (~:212) |
