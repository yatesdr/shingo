...
func (m *mockWarlinkClient) ReadTagValue(ctx context.Context, plcName, tagName string) (any, error) {
...
func (m *mockWarlinkClient) WriteTagValue(ctx context.Context, plcName, tagName string, value any) error {
	return nil
}
