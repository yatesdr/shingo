...
func (testEmitter) EmitOrderCreated(orderID int64, orderUUID, orderType string, payloadID *int64) {}
func (testEmitter) EmitOrderStatusChanged(orderID int64, orderUUID, orderType, oldStatus, newStatus, eta string, payloadID *int64) {
}
func (testEmitter) EmitOrderCompleted(orderID int64, orderUUID, orderType string, payloadID *int64) {}
