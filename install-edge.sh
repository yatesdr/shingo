...
# three stray shingoedge.yaml files -- a copy inside the checkout, a `shingo-test`
...
#    e. Bounded scan of /home/*/, /opt/*/, /srv/*/ for shingoedge.yaml.
LEGACY_CONFIG=""
...
if [ -z "$LEGACY_CONFIG" ]; then
    unit_cfg=$(config_from_unit "shingo-edge.service")
